...
#include <livox_ros2_driver/livox_interfaces/msg/CustomMsg.hpp> //livox_ros2_driver/livox_interfaces/msg/CustomMsg.msg
...
//   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  void process(const livox_ros2_driver::msg::CustomMsg::UniquePtr &msg, PointCloudXYZI::Ptr &pcl_out);
...
private:
  void avia_handler(const livox_ros2_driver::msg::CustomMsg::UniquePtr &msg);
